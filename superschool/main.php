  ...
  <div class="box box-solid bg-green">
    ...
    <li>
        ...
        <div class="timeline-item">
           ...
           <h3 class="timeline-header"><a href="#">Name:</a>Balaji</h3>
		   <h3 class="timeline-header"><a href="#">Mob.no:</a>(+91)7893794871</h3>
		   <h3 class="timeline-header"><a href="#">Email:</a>tripurabalaji77@gmail.com</h3>
            </div>
